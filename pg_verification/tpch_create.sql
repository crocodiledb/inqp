...
DROP TABLE IF EXISTS PART_FULL CASCADE;
CREATE TABLE PART_FULL (
...
DROP TABLE IF EXISTS SUPPLIER_FULL CASCADE;
CREATE TABLE SUPPLIER_FULL (
	S_SUPPKEY		BIGINT PRIMARY KEY,
	S_NAME			CHAR(25),
	S_ADDRESS		VARCHAR(40),
	S_NATIONKEY		BIGINT NOT NULL, -- references N_NATIONKEY
...
DROP TABLE IF EXISTS CUSTOMER_FULL CASCADE;
CREATE TABLE CUSTOMER_FULL (
	C_CUSTKEY		BIGINT PRIMARY KEY,
	C_NAME			VARCHAR(25),
	C_ADDRESS		VARCHAR(40),
	C_NATIONKEY		BIGINT NOT NULL, -- references N_NATIONKEY
...
DROP TABLE IF EXISTS NATION_FULL CASCADE;
CREATE TABLE NATION_FULL (
	N_NATIONKEY		BIGINT PRIMARY KEY,
	N_NAME			CHAR(25),
	N_REGIONKEY		BIGINT NOT NULL,  -- references R_REGIONKEY
	N_COMMENT		VARCHAR(152)
...
DROP TABLE IF EXISTS REGION_FULL CASCADE;
CREATE TABLE REGION_FULL (
	R_REGIONKEY	BIGINT PRIMARY KEY,
	R_NAME		CHAR(25),
	R_COMMENT	VARCHAR(152)
);
