...
public final class UnsafeRow extends InternalRow implements Externalizable, KryoSerializable {
  ...
  public void setInsert(boolean isInsert) {
    if (isInsert)
      ...
      BitSetMethods.set(baseObject, baseOffset, numFields + INSERT_OFFSET);
  }

  @Override
  public boolean isInsert() {
    return !BitSetMethods.isSet(baseObject, baseOffset, numFields + INSERT_OFFSET);
  }
  ...
  public void setUpdate(boolean isUpdate) {
    if (isUpdate)
      BitSetMethods.set(baseObject, baseOffset, numFields + UPDATE_OFFSET);
    else
  ...
  public boolean isUpdate() {
    return BitSetMethods.isSet(baseObject, baseOffset, numFields + UPDATE_OFFSET);
  }
